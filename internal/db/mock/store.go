...
func (m *MockStore) DeletePermission(arg0 context.Context, arg1 int64) (db.Permission, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) DeleteRole(arg0 context.Context, arg1 int64) (db.Role, error) {
	m.ctrl.T.Helper()
